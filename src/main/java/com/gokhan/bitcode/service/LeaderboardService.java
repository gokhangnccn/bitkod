...
public class LeaderboardService {
    ...
    public List<LeaderboardEntryDTO> getLeaderboard() {
        ...
        return users.stream().map(user -> {
                    ...
                    return new LeaderboardEntryDTO(userId, user.getUsername(), (int) solved, successRate, (int) total);
                }).sorted((a, b) -> Integer.compare(b.getSolvedProblemsCount(), a.getSolvedProblemsCount()))
